<template>
  <div>
    ...
    <div class="row">
      ...
      >
        <div>
          {{ beta.per_page}} , {{ beta.current_page }} {{ beta }}
          <b-form v-for="(vacancy, index) in vacancies" :key="index" :per-page="beta.per_page" :current-page="beta.current_page" >
            <div class="card mt-2">
          ...
          <div class="col">
            <div class="dataTables_paginate paging_simple_numbers float-right">
              <ul class="pagination pagination-rounded">
                <!-- pagination -->
                <b-pagination v-model="beta.current_page" :total-rows="beta.total" :per-page="beta.per_page"></b-pagination>
              </ul>
            </div>
          </div>
        </div>
